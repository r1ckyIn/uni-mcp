...
> **状态：开发中。** 目前已有的是 Claude 侧可安装骨架——一个 `install-check` 技能。setup 流程、知识层、Codex/ChatGPT 支持都在开发：进度见 [Issues](https://github.com/r1ckyIn/uni-mcp/issues)，设计定案在 [docs/design-decisions.md](docs/design-decisions.md)。本文件是占位版，完整双语门面随 [#9](https://github.com/r1ckyIn/uni-mcp/issues/9) 发布。
